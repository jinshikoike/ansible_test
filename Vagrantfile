...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_download_checksum = "2512290c28965f2447f91768f4eeae0fadd05516c9261d800323fe5fc0acd3ad"
  config.vm.box = "cent7.2"
  ...
  SHELL
  # config.vm.provision "ansible/playbook.yml"
end
